...
const InfoCard = ({
  ...
  return (
    <div className="flex cursor-pointer border-b py-7 px-2 pr-4 transition duration-200 ease-out first:border-t last:border-none hover:opacity-80 hover:shadow-lg">
        ...
        <div className="flex justify-between">
          ...
          <HeartIcon
            ...
            className={`h-7 cursor-pointer ${
              like ? 'fill-[#FF385C] text-[#FF385C]' : null
            }`}
          />
        </div>
